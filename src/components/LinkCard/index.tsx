...
export const createLinkCard = (baseurl: string) => {
  const useFetchLinkData = createUseFetchLinkData(baseurl);
  const LinkCard = ({ url, target = "_blank", titleTagName = "p", position = "center" }: LinkCardProps) => {
...
export const createLinkCardLarge = (baseurl: string) => {
  const useFetchLinkData = createUseFetchLinkData(baseurl);

  const LinkCardLarge = ({ url, target = "_blank", titleTagName = "p", position = "center" }: LinkCardProps) => {
    /** Call hook to fetch data from provided URL. */
    const { loading, error, data: linkCardData } = useFetchLinkData(url);
